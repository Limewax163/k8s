...
```
> [!NOTE]
> Название конфигурации может быть любым, важно что при вызове команды показываете на какой файл конфигурации будет ссылаться команда, в нашем случае это файл которые лежит в рабочей директории с названием <myklind.yaml>
